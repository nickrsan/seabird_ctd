...
class RabbitConsumer(object):
	"""
		Refactored the example consumer of messages in Pika's documentation to serve here.
	"""
	EXCHANGE = 'seabird'
	EXCHANGE_TYPE = 'topic'
	QUEUE = 'seabird'  # this should ultimately be set by the user, probably the calling function
	ROUTING_KEY = 'seabird'
	...
	def start_consuming(self):
		...
		self._consumer_tag = self._channel.basic_consume(self.handler, self.QUEUE)
	...
	def on_message(self, unused_channel, basic_deliver, properties, body):
		...
		"""
		log.debug('Received message # %s from %s: %s', basic_deliver.delivery_tag, properties.app_id, body)
